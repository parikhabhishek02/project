...
- pin_list:
  ...
  - {pin_num: '61', peripheral: SYSCON, signal: CLKOUT, pin_signal: PIO0_21/CLKOUT/FC0_TXD_SCL_MISO/CTIMER3_MAT0, mode: pullUp, invert: disabled, glitch_filter: disabled,
    slew_rate: standard, open_drain: disabled}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin21_config = (/* Pin is configured as CLKOUT */
                                         IOCON_PIO_FUNC1 |
                                         ...
                                         /* Open drain is disabled */
                                         IOCON_PIO_OPENDRAIN_DI);
    /* PORT0 PIN21 (coords: 61) is configured as CLKOUT */
