...
#define AUDIO_I2S_TX_FLEXCOMM_CLOCK_SOURCE (kSYS_PLL_to_FLEXCOMM6)
...
#define AUDIO_I2S_RX_FLEXCOMM_CLOCK_SOURCE (kSYS_PLL_to_FLEXCOMM7)
...
static void i2s_tx_init(void)
{
    ...
    SYSCON->STARTERSET[0] = SYSCON_STARTERP_FLEXCOMM6_MASK;
}
...
static void i2s_rx_init(void)
{
    ...
    SYSCON->STARTERSET[0] = SYSCON_STARTERP_FLEXCOMM7_MASK;
}
